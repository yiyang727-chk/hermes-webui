...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    profile_clone_skills_label: 'Also copy skills from active profile',
    profile_clone_skills_hint: 'Copies only the skills directory. Sessions, memories, logs, and cron data stay isolated.',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    profile_clone_skills_label: '同时复制当前配置档的技能',
    profile_clone_skills_hint: '只复制 skills 目录；sessions、memory、logs、cron 等运行数据仍保持隔离。',
